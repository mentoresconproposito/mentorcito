...
var LOOP_META = {
  "Reinvención": {
    ...
    descripcion: "El momento en que el ciclo anterior se cierra y empieza uno nuevo. Puede ser la entrada a producto desde otro rol, el salto a founder, o la decisión de convertirse en mentor o advisor. Alta energía, alta incertidumbre.",
    pregunta: "Que esta cambiando en tu carrera?",
  ...
  "Estancamiento": {
    ...
    descripcion: "El trabajo fluye pero algo no avanza. No es crisis visible — es una quietud que se instala. El profesional domina su rol pero siente que el crecimiento se detuvo. El estado más frecuente y el más subestimado.",
    pregunta: "Que te tiene bloqueado?",
  ...
  "Liderazgo": {
    ...
    descripcion: "El desafío ya no es técnico ni de ejecución — es humano. Influir sin autoridad formal, tomar decisiones con ambigüedad, construir contexto donde antes había instrucciones. El paso más difícil y el menos acompañado.",
    pregunta: "Como escalaas tu impacto?",
